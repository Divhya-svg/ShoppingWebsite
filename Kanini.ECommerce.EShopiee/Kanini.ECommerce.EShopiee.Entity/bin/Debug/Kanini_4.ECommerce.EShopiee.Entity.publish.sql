...
RETURN 0
GO
PRINT N'Creating [dbo].[MakeOrder]...';
...
RETURN 0
GO
PRINT N'Creating [dbo].[MakePayment]...';
...
RETURN 0
GO
PRINT N'Creating [dbo].[RemoveAProductFromWishList]...';


GO
CREATE PROCEDURE [dbo].[RemoveAProductFromWishList]
	@param1 int = 0,
	@param2 int
AS
	SELECT @param1, @param2
...
RETURN 0
GO
PRINT N'Creating [dbo].[UpdateDeliveryDetails]...';
...
RETURN 0
GO
PRINT N'Creating [dbo].[ViewUserDetails]...';


GO
CREATE PROCEDURE [dbo].[ViewUserDetails]
	@param1 int = 0,
	@param2 int
AS
	SELECT @param1, @param2
